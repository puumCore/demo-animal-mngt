...
namespace AutoVersion{
	...
	static const long REVISION  = 131;

	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 79;
	#define RC_FILEVERSION 1,0,23,131
	#define RC_FILEVERSION_STRING "1, 0, 23, 131\0"
	static const char FULLVERSION_STRING [] = "1.0.23.131";
